...
export default function Home() {
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <section className="grid gap-8 rounded-3xl bg-hero-gradient px-6 py-12 sm:px-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:px-14 lg:py-16">
        <div className="max-w-2xl">
          <p className="text-sm font-medium uppercase tracking-[0.18em] text-white/70">Skills Pathfinder</p>
          <h1 className="mt-4 text-4xl font-semibold tracking-tight text-white sm:text-5xl lg:text-[3.75rem] lg:leading-[1.02]">
        ...
        <Card className="overflow-hidden p-0">
          ...
          <div className="divide-y divide-slate-200">
            <div className="flex gap-4 px-6 py-5">
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-primary-100 bg-primary-50 text-sm font-semibold text-primary-700">1</div>
              <div>
            ...
            <div className="flex gap-4 px-6 py-5">
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-primary-100 bg-primary-50 text-sm font-semibold text-primary-700">2</div>
              <div>
            ...
            <div className="flex gap-4 px-6 py-5">
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-primary-100 bg-primary-50 text-sm font-semibold text-primary-700">3</div>
              <div>
